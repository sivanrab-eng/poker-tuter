...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    "common.you": "אתה",
    "common.pot": "פוט",
    "common.equity": "אקוויטי",
    "common.cancel": "ביטול",

    // Guided extras
    "guided.community.label": "קלפים קהילתיים",
    "guided.community.empty": "טרם נחשפו",
    "guided.your.label": "היד שלך",
    "guided.equity.label": "אקוויטי:",
    "guided.outs.heading": "🔢 אאוטס ופוט אודס",
    "guided.outs.total": "סה״כ: {n} אאוטס",
    "guided.outs.improve": "שיפור:",
    "guided.outs.no.draws": "אין דרואו ברורים בשלב זה.",
    "guided.outs.free.check": "✅ צ׳ק חינמי — תמיד נכון להמשיך!",
    "guided.outs.free.bonus": "{n} אאוטס ({odds}% לשפר) — ללא עלות",
    "guided.hint.btn.full": "💡 רמז — הצג משתנים להחלטה",
    "guided.message.welcome": "ברוכים הבאים! בחר פעולה לשלב הפרה-פלופ.",
    "guided.message.new": "משחק חדש! בחר פעולה לשלב הפרה-פלופ.",
    "guided.message.chose": "בחרת: {action}",
    "guided.message.bot.did": "הבוט עשה {action}.",
    "guided.message.bot.your.turn": "הבוט עשה {action}. תורך!",
    "guided.message.showdown": "שואדאון! חשיפת הקלפים...",
    "guided.message.phase": "{phase} — בחר פעולה.",
    "guided.phase.label": "שלב: {phase}",
    "guided.pot.full": "פוט: {n}",

    // Hint extras
    "hint.heading": "💡 רמז — {phase}",
    "hint.var.pot.label": "פוט (Pot)",
    "hint.var.pot.value": "{n} צ'יפס",
    "hint.var.pot.exp": "הפוט הוא סך כל הצ'יפס שהושקעו ביד הנוכחית.\n\n📐 חישוב: סכום כל ההימורים מכל השלבים = {n} צ'יפס.\n\nככל שהפוט גדול יותר, כך משתלם יותר לנסות לזכות בו.",
    "hint.var.tocall.label": "עלות קול (To Call)",
    "hint.var.tocall.free": "חינמי ✅",
    "hint.var.tocall.value": "{n} צ'יפס",
    "hint.var.tocall.exp.free": "אין הימור לשלם — אתה יכול לעשות צ'ק בחינם.\n\n📐 חישוב: הימור הבוט ({bot}) − ההימור שלך ({me}) = 0.\n\nתמיד נכון להמשיך כשאין עלות!",
    "hint.var.tocall.exp.cost": "כמה צ'יפס אתה צריך לשלם כדי להישאר ביד.\n\n📐 חישוב: הימור הבוט ({bot}) − ההימור שלך ({me}) = {n} צ'יפס.\n\nזה הסכום שצריך לבדוק אם 'שווה' לשלם.",
    "hint.var.potodds.label": "פוט אודס (Pot Odds)",
    "hint.var.potodds.zero": "0% (חינמי)",
    "hint.var.potodds.value": "{n}%",
    "hint.var.potodds.exp.free": "פוט אודס = עלות הקול / (הפוט + עלות הקול)\n\n📐 חישוב: 0 / ({pot} + 0) = 0%\n\nכשהפוט אודס הם 0%, כל סיכוי שיפור הופך את ההמשך לרווחי.",
    "hint.var.potodds.exp.cost": "פוט אודס = עלות הקול / (הפוט + עלות הקול)\n\n📐 חישוב: {n} / ({pot} + {n}) = {odds}%\n\nאם סיכוי השיפור שלך גבוה מ-{odds}%, הקול רווחי.",
    "hint.var.potodds.exp.na": "פוט אודס מחושבים מהפלופ ואילך.",
    "hint.var.outs.label": "אאוטס (Outs)",
    "hint.var.outs.exp": "אאוטס = קלפים בחפיסה שישפרו את היד שלך.\n\n📐 נותרו {remaining} קלפים בחפיסה.\n{lines}\n\nסה״כ: {total} אאוטס מתוך {remaining} קלפים.",
    "hint.var.outs.line": "• {name}: {n} אאוטס",
    "hint.var.outs.none": "• אין דרואו ספציפיים",
    "hint.var.improve.label": "סיכוי שיפור (%)",
    "hint.var.improve.value": "{n}%",
    "hint.var.improve.value.runout": "{n}% ({runout}% עד ריבר)",
    "hint.var.improve.exp.next": "סיכוי שיפור = אאוטס / קלפים שנותרו\n\n📐 חישוב (קלף הבא): {outs} / {remaining} = {odds}%\n\nככל שיש יותר אאוטס, הסיכוי לשפר יד גדל.",
    "hint.var.improve.exp.runout": "סיכוי שיפור = אאוטס / קלפים שנותרו\n\n📐 חישוב (קלף הבא): {outs} / {remaining} = {odds}%\n\n📐 חישוב (עד ריבר — כלל ה-4×): {outs} × 4 ≈ {ruleOf4}% (מדויק: {runout}%)\n\nככל שיש יותר אאוטס, הסיכוי לשפר יד גדל.",
    "hint.var.equity.label": "אקוויטי (Equity)",
    "hint.var.equity.value": "{n}%",
    "hint.var.equity.exp": "אקוויטי = הסיכוי הכולל שלך לזכות ביד.\n\n📐 ערך נוכחי: {n}%\n\nזה כולל גם את הסיכוי שהיד שלך כבר מנצחת עכשיו וגם את הסיכוי לשפר.\n\n• מעל 65% → רייז (בנה פוט)\n• 45-65% → קול (יד סבירה)\n• מתחת ל-30% → שקול פולד",
    "hint.compare.heading": "📊 השוואת פעולות",
    "hint.compare.var": "משתנה",
    "hint.compare.check": "צ׳ק",
    "hint.compare.call": "קול",
    "hint.compare.raise": "רייז",
    "hint.compare.fold": "פולד",
    "hint.compare.cost": "💰 עלות",
    "hint.compare.pot.after": "🏦 פוט אחרי",
    "hint.compare.potodds": "📐 Pot Odds",
    "hint.compare.equity": "📈 Equity",
    "hint.compare.outs": "🎯 אאוטס",
    "hint.compare.improve": "📊 שיפור %",
    "hint.compare.risk": "⚠️ סיכון",
    "hint.rec.heading": "המלצת פעולה",
    "hint.rec.check.action": "צ׳ק / רייז",
    "hint.rec.check.reason": "אין עלות להמשיך (צ׳ק חינמי). תמיד נכון לראות עוד קלפים בחינם.\n\nאם יש לך יד חזקה (אקוויטי {equity}%), שקול רייז כדי לבנות פוט.",
    "hint.rec.call.action": "קול ✅",
    "hint.rec.call.reason": "סיכוי השיפור שלך ({improve}%) גבוה מפוט אודס ({potodds}%).\nסטטיסטית, לאורך זמן, הקול ירוויח כסף.",
    "hint.rec.raise.action": "רייז",
    "hint.rec.raise.reason": "אקוויטי גבוה של {equity}% — יד חזקה.\nכדאי לבנות פוט ולגרום ליריב לשלם.",
    "hint.rec.fold.action": "פולד ❌",
    "hint.rec.fold.reason": "סיכוי השיפור ({improve}%) נמוך מפוט אודס ({potodds}%).\nלאורך זמן, קול כאן יפסיד כסף.",
    "hint.rec.fold2.action": "פולד",
    "hint.rec.fold2.reason": "אקוויטי נמוך ({equity}%) — סיכוי נמוך לנצח.\nעדיף לחסוך צ׳יפס למשחקים עם יד טובה יותר.",
    "hint.rec.callsoft.action": "קול",
    "hint.rec.callsoft.reason": "אקוויטי סביר ({equity}%). שווה לראות עוד קלפים אם המחיר סביר.",
    "hint.action.fold.title": "פולד — ניתוח",
    "hint.action.call.title": "קול / צ׳ק — ניתוח",
    "hint.action.callcost.title": "קול — ניתוח",
    "hint.action.raise.title": "רייז — ניתוח",
    "hint.fold.line.heading": "📐 ניתוח פולד:",
    "hint.fold.line.giveup": "• אתה מוותר על הפוט ({pot} צ׳יפס).",
    "hint.fold.line.invested": "• הפסד מצטבר ביד: {n} צ׳יפס שכבר השקעת.",
    "hint.fold.line.equity": "• אקוויטי נוכחי: {n}% — {note}",
    "hint.fold.line.equity.high": "גבוה מדי לוותר!",
    "hint.fold.line.equity.low": "נמוך, ויתור סביר.",
    "hint.fold.line.potodds": "• פוט אודס: {pot}% | סיכוי שיפור: {improve}%",
    "hint.fold.line.profitable": "\n❌ הקול רווחי כאן — פולד מבזבז הזדמנות!",
    "hint.fold.line.unprofitable": "\n✅ הקול לא רווחי — פולד חוסך {n} צ׳יפס.",
    "hint.fold.line.weak": "\n✅ יד חלשה — פולד חוסך כסף לטווח ארוך.",
    "hint.fold.line.consider": "\n⚠️ שקול צ׳ק/קול לפני שמוותר — יד לא חלשה.",
    "hint.call.line.heading": "📐 ניתוח קול ({label}):",
    "hint.call.line.label.free": "צ׳ק חינמי",
    "hint.call.line.label.cost": "עלות: {n}",
    "hint.call.line.newpot": "• פוט אחרי קול: {pot} + {tocall} = {newpot} צ׳יפס",
    "hint.call.line.zero.cost": "• עלות: 0 — אין סיכון!",
    "hint.call.line.equity": "• אקוויטי: {n}%",
    "hint.call.line.zero.right": "\n✅ צ׳ק חינמי — תמיד נכון להמשיך.",
    "hint.call.line.zero.outs": "   {n} אאוטס ({improve}% לשפר) ללא עלות.",
    "hint.call.line.potodds": "• פוט אודס: {tocall} / {newpot} = {potodds}%",
    "hint.call.line.outs": "• אאוטס: {n} | סיכוי שיפור: {improve}%",
    "hint.call.line.profitable": "\n✅ קול רווחי! סיכוי שיפור ({improve}%) > פוט אודס ({potodds}%).",
    "hint.call.line.profitable.long": "   לאורך 100 ידיים כאלה, תרוויח בממוצע.",
    "hint.call.line.unprofitable": "\n❌ קול לא רווחי: סיכוי שיפור ({improve}%) < פוט אודס ({potodds}%).",
    "hint.call.line.unprofitable.long": "   לאורך 100 ידיים כאלה, תפסיד בממוצע.",
    "hint.raise.line.heading": "📐 ניתוח רייז ({size} צ׳יפס):",
    "hint.raise.line.cost": "• עלות: {tocall} (קול) + {size} (העלאה) = {total} צ׳יפס",
    "hint.raise.line.newpot": "• פוט אחרי רייז: ~{newpot} צ׳יפס",
    "hint.raise.line.equity": "• אקוויטי: {n}%",
    "hint.raise.line.outs": "• אאוטס: {outs} | שיפור: {improve}%",
    "hint.raise.line.strong": "\n✅ רייז חזק! אקוויטי גבוה ({n}%) — בנה פוט.",
    "hint.raise.line.strong.long": "   לחץ על היריב ותגרום לו לטעויות.",
    "hint.raise.line.semibluff": "\n⚠️ רייז כ-בלאף (סמי-בלאף): אקוויטי {n}%.",
    "hint.raise.line.semibluff.long": "   יכול לעבוד אם היריב יפלד, אבל מסוכן.",
    "hint.raise.line.risky": "\n❌ רייז מסוכן! אקוויטי נמוך ({n}%).",
    "hint.raise.line.risky.long": "   אתה משקיע {total} צ׳יפס עם סיכוי נמוך לזכות.",

    // Report extras
    "report.heading": "📊 דו״ח אנליסט",
    "report.cards.heading": "הקלפים",
    "report.cards.you": "שלך",
    "report.cards.bot": "בוט",
    "report.timeline.heading": "📜 רצף היד",
    "report.timeline.you": "אתה",
    "report.timeline.bot": "בוט",
    "report.timeline.decided": "🏁 היד הוכרעה בשלב:",
    "report.timeline.bot.folded": " — הבוט פילד!",
    "report.timeline.you.folded": " — פילדת",
    "report.analyst.heading": "🧠 מה האנליסט היה עושה",
    "report.rec.raise": "בשלב {phase}, עם אקוויטי של {n}%, הפעולה הנכונה היא רייז. יד חזקה שצריך לבנות איתה פוט.",
    "report.rec.call": "בשלב {phase}, עם אקוויטי של {n}%, הפעולה הנכונה היא קול. יד סבירה ששווה לראות עוד קלפים.",
    "report.rec.checkcall": "בשלב {phase}, עם אקוויטי של {n}%, אפשר לעשות צ'ק/קול אם המחיר נמוך, אבל להיזהר מהשקעה גדולה.",
    "report.rec.fold": "בשלב {phase}, עם אקוויטי של {n}%, עדיף פולד. הסיכוי לזכות נמוך מדי ביחס לעלות.",
    "report.outs.heading": "🔢 אאוטס ופוט אודס — ניתוח לפי שלב",
    "report.outs.pot": "פוט:",
    "report.outs.callcost": "עלות קול:",
    "report.outs.potodds": "פוט אודס (עלות/פוט+עלות):",
    "report.outs.free": "צ׳ק חינמי ✅",
    "report.outs.remaining": "קלפים שנותרו בחפיסה:",
    "report.outs.totalouts": "סה״כ אאוטס:",
    "report.outs.improve.next": "סיכוי שיפור (קלף הבא):",
    "report.outs.improve.river": "סיכוי שיפור (עד ריבר):",
    "report.outs.improve.toriver": "שיפור עד ריבר:",
    "report.outs.improve": "שיפור:",
    "report.outs.no.draws": "אין דרואו ברורים בשלב זה.",
    "report.outs.outslabel": "{n} אאוטס",
    "report.outs.profitable": "קול רווחי",
    "report.outs.unprofitable": "קול לא רווחי",
    "report.outs.free.heading": "✅ צ׳ק חינמי — תמיד נכון להמשיך",
    "report.outs.free.calc1": "📐 חישוב: Pot = {pot}, toCall = 0",
    "report.outs.free.calc2": "→ Pot Odds = toCall / (Pot + toCall) = 0 / ({pot}+0) = 0%",
    "report.outs.free.calc3": "→ אאוטס: {outs} מתוך {remaining} קלפים",
    "report.outs.free.calc4": "→ סיכוי שיפור (קלף הבא): {outs}/{remaining} = {odds}%",
    "report.outs.free.calc5": "→ סיכוי שיפור (עד ריבר): ≈ {runout}%",
    "report.outs.free.calc6": "→ כל אחוז שיפור > 0% = קול/צ׳ק תמיד רווחי",
    "report.outs.free.example.heading": "📊 דוגמה עם המספרים שלך:",
    "report.outs.free.example1": "הפוט עומד על {pot} צ׳יפס ואתה לא צריך לשלם כלום (toCall=0).",
    "report.outs.free.example2": "יש לך {outs} אאוטס מתוך {remaining} קלפים שנותרו בחפיסה.",
    "report.outs.free.example3": "סיכוי לשפר יד בקלף הבא: {outs}÷{remaining} = {odds}%.",
    "report.outs.free.example4": "סיכוי לשפר עד הריבר (2 קלפים): ≈ {runout}% (כלל ה-4×אאוטס ≈ {ruleOf4}%).",
    "report.outs.free.example5": "כיוון ש-Pot Odds = 0% ואילו סיכוי השיפור = {odds}%, תמיד משתלם להמשיך.",
    "report.outs.free.example.no.outs": "אין אאוטס לשיפור, אבל מכיוון שאין עלות — עדיף לצ׳ק ולראות קלפים בחינם.",
    "report.equity.heading": "📈 אקוויטי סופי",
    "report.equity.label": "אקוויטי שלך:",
    "report.newgame": "🃏 משחק חדש",
    "report.win.title": "🏆 ניצחון!",
    "report.loss.title": "😞 הפסד",
    "report.tie.title": "🤝 תיקו",
    "report.win.summary": "יד מנצחת: {name}. פוט סופי: {pot} צ׳יפס.",

    // Two Player
    "two.title": "🃏 משחק לשניים",
    "two.lobby.title": "שני שחקנים — שני מכשירים",
    "two.lobby.subtitle": "כל אחד רואה את הקלפים שלו בלבד",
    "two.lobby.create": "✨ צור חדר חדש",
    "two.lobby.join.label": "הצטרף לחדר קיים",
    "two.lobby.join.placeholder": "הכנסי קוד חדר...",
    "two.lobby.join.btn": "הצטרף →",
    "two.lobby.error.notfound": "חדר לא נמצא. בדקי את הקוד.",
    "two.lobby.error.full": "החדר כבר מלא.",
    "two.waiting.title": "ממתין...",
    "two.waiting.player": "ממתין לשחקן 2...",
    "two.waiting.dealer": "ממתין לדילר...",
    "two.waiting.send": "שלח את הקוד לחבר:",
    "two.waiting.share": "שתף",
    "two.waiting.copy": "העתק קוד",
    "two.share.text": "🃏 בוא לשחק איתי פוקר!\n\nכנס לקישור, בחר \"הצטרף לחדר\" והכנס את הקוד:\n\n*{code}*\n\n{url}",
    "two.share.title": "בוא לשחק פוקר!",
    "two.share.copy": "קוד חדר: {code}\n{url}",
    "two.game.player": "🃏 שחקן {n}",
    "two.game.pot": "סיר {n}",
    "two.game.opp.label": "👤 יריב (שחקן {n})",
    "two.game.board": "🂠 לוח — {stage}",
    "two.game.your.cards": "✋ הקלפים שלך",
    "two.game.your.turn": "🟢 התור שלך!",
    "two.game.waiting.opp": "🟡 ממתין ליריב...",
    "two.game.you.won": "ניצחת!",
    "two.game.you.lost": "הפסדת",
    "two.game.tie": "תיקו!",
    "two.game.eval.row": "ש׳1: {p1} · ש׳2: {p2}",
    "two.game.btn.call": "✅ קול",
    "two.game.btn.raise": "📈 רייז",
    "two.game.btn.fold": "❌ פולד",
    "two.game.btn.new": "🔄 סיבוב חדש",
    "two.game.btn.waiting": "ממתין לדילר...",
    "two.stage.preflop": "פרה-פלופ",
    "two.stage.flop": "פלופ",
    "two.stage.turn": "טרן",
    "two.stage.river": "ריבר",
    "two.stage.showdown": "שואדאון",

    // Coach Chat
    "coach.chat.title": "המאמן — שאל הכל על פוקר",
    "coach.chat.tooltip": "שאל את המאמן",
    "coach.chat.greet1": "🎓 שלום! אני המאמן שלך.",
    "coach.chat.greet2": "שאל אותי כל שאלה על פוקר — אסטרטגיה, חוקים, הסתברות.",
    "coach.chat.greet3": "אני רואה את המשחק הנוכחי שלך ויכול להתייחס אליו!",
    "coach.chat.suggest1": "מה לעשות עם היד הזו?",
    "coach.chat.suggest2": "מה זה אאוטס?",
    "coach.chat.suggest3": "מתי לעשות רייז?",
